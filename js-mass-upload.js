(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.MassUpload = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
var Backbone, FileDeleter, FileLister, FileUploader, MassUpload, State, UploadCollection, UploadProgress, _,
...
UploadCollection = _dereq_('./MassUpload/UploadCollection');

FileLister = _dereq_('./MassUpload/FileLister');

FileUploader = _dereq_('./MassUpload/FileUploader');

FileDeleter = _dereq_('./MassUpload/FileDeleter');

State = _dereq_('./MassUpload/State');

UploadProgress = _dereq_('./MassUpload/UploadProgress');

module.exports = MassUpload = (function(superClass) {
  extend(MassUpload, superClass);
  ...
  MassUpload.prototype.initialize = function(attributes, options) {
    var ref, resetUploadProgress;
    this._options = options;
    this.uploads = (ref = options != null ? options.uploads : void 0) != null ? ref : new UploadCollection();
    this._uploadProgress = new UploadProgress({
      uploadCollection: this.uploads
    });
    resetUploadProgress = (function(_this) {
      return function() {
        return _this.set({
    ...
    this.listenTo(this.uploads, 'change', (function(_this) {
      return function(upload) {
        return _this._onUploadChanged(upload);
      };
    })(this));
    this.listenTo(this.uploads, 'reset', (function(_this) {
      return function() {
  ...
  MassUpload.prototype.prepare = function() {
    ...
    this.lister = (ref = options != null ? options.lister : void 0) != null ? ref : new FileLister(options.doListFiles);
    ...
    this.uploader = (ref1 = options != null ? options.uploader : void 0) != null ? ref1 : new FileUploader(options.doUploadFile);
    this.uploader.callbacks = {
      ...
      onError: (function(_this) {
        return function(file, errorDetail) {
          return _this._onUploaderError(file, errorDetail);
        };
      })(this),
      onProgress: (function(_this) {
        return function(file, progressEvent) {
          return _this._onUploaderProgress(file, progressEvent);
        };
      })(this)
    };
    this.deleter = (ref2 = options != null ? options.deleter : void 0) != null ? ref2 : new FileDeleter(options.doDeleteFile);
    return this.deleter.callbacks = {
      ...
      onError: (function(_this) {
        return function(fileInfo, errorDetail) {
  ...
  MassUpload.prototype.addFiles = function(files) {
    return this._uploadProgress.inBatch((function(_this) {
      return function() {
...
},{"./MassUpload/FileDeleter":4,"./MassUpload/FileLister":6,"./MassUpload/FileUploader":7,"./MassUpload/State":8,"./MassUpload/UploadCollection":10,"./MassUpload/UploadProgress":11,"backbone":2,"underscore":3}],2:[function(_dereq_,module,exports){
//     Backbone.js 1.1.2
...
},{"underscore":3}],3:[function(_dereq_,module,exports){
//     Underscore.js 1.8.3
...
module.exports = FileDeleter = (function() {
  ...
  FileDeleter.prototype.run = function(fileInfo) {
    ...
    this.running = true;
    if (typeof (base = this.callbacks).onStart === "function") {
      base.onStart(fileInfo);
    }
    return this.doDeleteFile(fileInfo, ((function(_this) {
      return function() {
  ...
  FileDeleter.prototype._onSuccess = function(fileInfo) {
    var base;
    if (typeof (base = this.callbacks).onSuccess === "function") {
      base.onSuccess(fileInfo);
    }
  ...
  FileDeleter.prototype._onError = function(fileInfo, errorDetail) {
    var base;
    if (typeof (base = this.callbacks).onError === "function") {
      base.onError(fileInfo, errorDetail);
    }
    return this._onStop(fileInfo);
  };
  ...
  FileDeleter.prototype._onStop = function(fileInfo) {
    var base;
    this.running = false;
    if (typeof (base = this.callbacks).onStop === "function") {
      base.onStop(fileInfo);
    }
    return void 0;
  };
...
module.exports = FileLister = (function() {
  ...
  FileLister.prototype.run = function() {
    ...
    return this.doListFiles(((function(_this) {
      return function(progressEvent) {
        var base1;
        return typeof (base1 = _this.callbacks).onProgress === "function" ? base1.onProgress(progressEvent) : void 0;
      };
    })(this)), ((function(_this) {
      return function(fileInfos) {
  ...
  FileLister.prototype._onStop = function() {
    var base;
    this.running = false;
    return typeof (base = this.callbacks).onStop === "function" ? base.onStop() : void 0;
  };
...
var FileInfo, FileUploader;

FileInfo = _dereq_('./FileInfo');
...
module.exports = FileUploader = (function() {
  ...
  FileUploader.prototype.run = function(file) {
    ...
    this._file = file;
    if (typeof (base = this.callbacks).onStart === "function") {
      base.onStart(this._file);
    }
    return this._abortCallback = this.doUpload(file, ((function(_this) {
      return function(progressEvent) {
  ...
  FileUploader.prototype._onProgress = function(file, progressEvent) {
    var base;
    return typeof (base = this.callbacks).onProgress === "function" ? base.onProgress(file, progressEvent) : void 0;
  };
  ...
  FileUploader.prototype._onStop = function(file) {
    ...
    this._abortCallback = null;
    this._aborting = false;
    return typeof (base = this.callbacks).onStop === "function" ? base.onStop(file) : void 0;
  };
...
},{"./FileInfo":5}],8:[function(_dereq_,module,exports){
var State;
...
module.exports = State = (function() {
  function State(attrs) {
    ...
    this.loaded = (ref = attrs.loaded) != null ? ref : 0;
    this.total = (ref1 = attrs.total) != null ? ref1 : 0;
    this.status = (ref2 = attrs.status) != null ? ref2 : 'waiting';
    this.errors = (ref3 = attrs.errors) != null ? ref3 : [];
  }

  State.prototype._extend = function(attrs) {
    var ref, ref1, ref2, ref3;
    return new State({
      loaded: (ref = attrs.loaded) != null ? ref : this.loaded,
      total: (ref1 = attrs.total) != null ? ref1 : this.total,
      status: (ref2 = attrs.status) != null ? ref2 : this.status,
      errors: (ref3 = attrs.errors) != null ? ref3 : this.errors
    });
  };
...
var Backbone, FileInfo, Upload, _;
...
module.exports = Upload = (function() {
  ...
  function Upload(attributes) {
    var ref, ref1, ref2;
    this.file = (ref = attributes.file) != null ? ref : null;
    this.fileInfo = (ref1 = attributes.fileInfo) != null ? ref1 : null;
  ...
  Upload.prototype.size = function() {
    var ref;
    return this._size != null ? this._size : this._size = (ref = this.file) != null ? ref.size : void 0;
  };

  Upload.prototype.lastModifiedDate = function() {
    var ref;
    return this._lastModifiedDate != null ? this._lastModifiedDate : this._lastModifiedDate = (ref = this.file) != null ? ref.lastModifiedDate : void 0;
  };
  ...
  Upload.prototype.hasConflict = function() {
    var ref, ref1;
    return (this.fileInfo != null) && (this.file != null) && (this.fileInfo.name !== this.id || this.fileInfo.total !== this.size() || ((ref = this.fileInfo.lastModifiedDate) != null ? typeof ref.getTime === "function" ? ref.getTime() : void 0 : void 0) !== ((ref1 = this.lastModifiedDate()) != null ? typeof ref1.getTime === "function" ? ref1.getTime() : void 0 : void 0));
  };
...
},{"./FileInfo":5,"backbone":2,"underscore":3}],10:[function(_dereq_,module,exports){
var Backbone, Upload, UploadCollection, UploadPriorityQueue;

Backbone = _dereq_('backbone');

Upload = _dereq_('./Upload');
...
UploadPriorityQueue = (function() {
  ...
  UploadPriorityQueue.prototype.next = function() {
    var ref, ref1, ref2, ref3;
    return (ref = (ref1 = (ref2 = (ref3 = this.deleting[0]) != null ? ref3 : this.uploading[0]) != null ? ref2 : this.unfinished[0]) != null ? ref1 : this.unstarted[0]) != null ? ref : null;
  };
...
module.exports = UploadCollection = (function() {
  ...
  UploadCollection.prototype.reset = function(uploads) {
    var i, j, len, len1, ref, ref1, upload;
    ref = this.models;
    ...
    this.models = (function() {
      ...
      ref1 = uploads != null ? uploads : [];
      results = [];
      for (j = 0, len1 = ref1.length; j < len1; j++) {
        upload = ref1[j];
        results.push(this._prepareModel(upload));
      }
      return results;
    }).call(this);
...
},{"./Upload":9,"backbone":2}],11:[function(_dereq_,module,exports){
var Backbone, UploadProgress,
  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  hasProp = {}.hasOwnProperty;

Backbone = _dereq_('backbone');

module.exports = UploadProgress = (function(superClass) {
  extend(UploadProgress, superClass);

  function UploadProgress() {
    return UploadProgress.__super__.constructor.apply(this, arguments);
  }

  UploadProgress.prototype.defaults = {
    loaded: 0,
    total: 0
  };
  ...
  UploadProgress.prototype._adjust = function(dLoaded, dTotal) {
    return this.set({
  ...
  UploadProgress.prototype.add = function(model) {
    var progress;
  ...
  UploadProgress.prototype.reset = function(collection) {
    var i, idToLastKnownProgress, len, loaded, model, progress, ref, total;
  ...
  UploadProgress.prototype.remove = function(model) {
    var progress;
    progress = model.getProgress();
    this._adjust(-progress.loaded, -progress.total);
    return this._idToLastKnownProgress[model.id] = progress;
  ...
  UploadProgress.prototype.change = function(model) {
  ...
  UploadProgress.prototype._updateAndStartListening = function() {
    var collection, event, i, len, ref;
    collection = this.get('uploadCollection');
    ref = ['add', 'remove', 'change', 'reset'];
    for (i = 0, len = ref.length; i < len; i++) {
      event = ref[i];
  ...
  UploadProgress.prototype.inBatch = function(callback) {
